...
Each member is uniquely identified to HealthLX by this element:

`roster/member/unique_person_ids/unique_person_id`

HealthLX requires the `unique_person_id` value as the unique and permanent identifier for the patient across all submissions, regardless of other identifying information that is subject to change (such as the member ID used in various plans).

The complex `roster/member/member_identity` element was formerly noted as required, but it is not required in version 6.1. HealthLX does not use these values.

<h2 id="appendix-a-value-sets" style="color:#E60073">Appendix A – Value Sets</h2>

These value sets were updated on July 24, 2020. For updated value sets, visit [http://hl7.org/fhir/](http://hl7.org/fhir/).

<h3 style="color:#E60073">Core Race Detailed Code</h3>

The core race detailed list is too large to be included in this guide. An up-to-date version can be found here: [http://hl7.org/fhir/us/core/ValueSet-detailed-race.html](http://hl7.org/fhir/us/core/ValueSet-detailed-race.html).

<h3 style="color:#E60073">Ethnicity Detailed Code</h3>

The updated ethnicity detailed code list can be found here: [http://hl7.org/fhir/us/core/ValueSet-detailed-ethnicity.html](http://hl7.org/fhir/us/core/ValueSet-detailed-ethnicity.html).

| Code | Display | Definition |
| --- | --- | --- |
| 2133-7 | Ethnicity | Note that this is an abstract 'grouping' concept and not for use as a real concept |
| 2137-8 | Spaniard | Spaniard |
| 2148-5 | Mexican | Mexican |
| 2155-0 | Central American | Central American |
| 2165-9 | South American | South American |
| 2178-2 | Latin American | Latin American |
| 2180-8 | Puerto Rican | Puerto Rican |
| 2182-4 | Cuban | Cuban |
| 2184-0 | Dominican | Dominican |
| 2138-6 | Andalusian | Andalusian |
| 2139-4 | Asturian | Asturian |
| 2140-2 | Castillian | Castillian |
| 2141-0 | Catalonian | Catalonian |
| 2142-8 | Belearic Islander | Belearic Islander |
| 2143-6 | Gallego | Gallego |
| 2144-4 | Valencian | Valencian |
| 2145-1 | Canarian | Canarian |
| 2146-9 | Spanish Basque | Spanish Basque |
| 2149-3 | Mexican American | Mexican American |
| 2150-1 | Mexicano | Mexicano |
| 2151-9 | Chicano | Chicano |
| 2152-7 | La Raza | La Raza |
| 2153-5 | Mexican American Indian | Mexican American Indian |
| 2156-8 | Costa Rican | Costa Rican |
| 2157-6 | Guatemalan | Guatemalan |
| 2158-4 | Honduran | Honduran |
| 2159-2 | Nicaraguan | Nicaraguan |
| 2160-0 | Panamanian | Panamanian |
| 2161-8 | Salvadoran | Salvadoran |
| 2162-6 | Central American Indian | Central American Indian |
| 2163-4 | Canal Zone | Canal Zone |
| 2166-7 | Argentinean | Argentinean |
| 2167-5 | Bolivian | Bolivian |
| 2168-3 | Chilean | Chilean |
| 2169-1 | Colombian | Colombian |
| 2170-9 | Ecuadorian | Ecuadorian |
| 2171-7 | Paraguayan | Paraguayan |
| 2172-5 | Peruvian | Peruvian |
| 2173-3 | Uruguayan | Uruguayan |
| 2174-1 | Venezuelan | Venezuelan |
| 2175-8 | South American Indian | South American Indian |
| 2176-6 | Criollo | Criollo |
{: .heatMap}

<h3 style="color:#E60073">Relationship Codes</h3>

The updated relationship codes list can be found here: [https://www.hl7.org/fhir/valueset-subscriber-relationship.html](https://www.hl7.org/fhir/valueset-subscriber-relationship.html)
...
The updated language code list can be found here: [https://www.hl7.org/fhir/valueset-languages.html](https://www.hl7.org/fhir/valueset-languages.html)
...
The updated smoking status list can be found here: [http://hl7.org/fhir/us/core/STU3.1.1/ValueSet-us-core-observation-smokingstatus.html](http://hl7.org/fhir/us/core/STU3.1.1/ValueSet-us-core-observation-smokingstatus.html)
